...
# define an __init__()function that accepts self, x, y, and z, and assigns these numbers 
# to the member variables self.x,self.y,self.z. Define a __repr__() method 
# that returns "(%d, %d, %d)" % (self.x, self.y, self.z). This tells Python to represent 
